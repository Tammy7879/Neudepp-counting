...
import ProductInfo  from "./DataTabs/ProductInfo";
import { signOut } from "../../custom_libraries/auth";
import ImportData from "./DataTabs/ImportData";
                        ...
                        {/* <div className='col-md-2 border-right bg-light d-flex justify-content-center align-items-center'>
                            <div>
                                ...
                                <Button
                                    ...
                                    className="bg-white w-100 mt-3"
                                    onClick={this.userLogin}>
                                    <KeyboardArrowUp className="mr-2" />
                                    <b>Scroll <br />To Up</b>
                                </Button>
                                <Button
                                    variant="contained"
                                    ...
                                    className="bg-white w-100 mt-3"
                                    onClick={this.userLogin}>
                                    <KeyboardArrowDown className="mr-2" />
                                    <b>Scroll <br />To Down</b>
                                </Button>
                                <Button
                                    variant="contained"
                                    size="medium"
                                    className="bg-white w-100 mt-4 mb-2"
                                ...
                                <AppBar position="sticky" color='default'>
                                    <Toolbar className='bg-white p-0'>
                                        <Tabs
                                            ...
                                            <Tab component="div" label={<span style={{ fontWeight: 'bold' }}>Product Info </span>} />
                                            <Tab component="div" label={<span style={{ fontWeight: 'bold' }}> Import </span>} />
                                        </Tabs>
                                    </Toolbar>
                                </AppBar>
                            </div>
